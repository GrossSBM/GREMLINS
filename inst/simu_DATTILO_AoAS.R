...
dirSaveSimuData <- '/home/donnet/WORK_ALL/RECHERCHE/TRAVAUX_RECHERCHE/Avner-Pierre/Ecologie/Code/generalized_multi_BM/res_simu_AoAS/res_simu_AoAS_DATTILO/param1/data'
#
# for (i in 1:nSimu) {
#   datasim <- rMBM(v_NQ ,E , typeInter, v_distrib, list_pi, list_theta, seed = NULL, namesFG = namesFG, keepClassif = TRUE)
#   namedata  <- paste('datasim',i,'.Rdata',sep = "")
#   save(datasim,file = paste(dirSaveSimuData,namedata,sep = '/' ))
>>>>>>> Stashed changes
# }
...
#---------------- ESTIMATION ------------------------------------
dirSaveSimuRes <- '/home/donnet/WORK_ALL/RECHERCHE/TRAVAUX_RECHERCHE/Avner-Pierre/Ecologie/Code/generalized_multi_BM/res_simu_AoAS/res_simu_AoAS_DATTILO/param1/res_MBM'
for (i in 1:nSimu)
  {
  print(i)
  #load data
...
#   # estim
#   #res_estim <- MultipartiteBM(listNet, namesfg = namesfg, vdistrib = vdistrib , v_Kmin = 1 , v_Kmax = 10 , v_Kinit = c(1,1,1,1), init.BM = TRUE, save = FALSE , verbose = FALSE,nb_cores = 10)
#   nameres  <- paste('resMBM_',i,'.Rdata',sep = "")
